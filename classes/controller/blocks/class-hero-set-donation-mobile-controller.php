...
if ( ! class_exists( 'Hero_Set_Donation_Mobile_Controller' ) ) {
	/**
	 * Class Hero_Set_Donation_Mobile_Controller
	 *
	 * @package P4EABKS\Controllers\Blocks
	 */
	class Hero_Set_Donation_Mobile_Controller extends Controller {
		 ...
		 */
		const BLOCK_NAME = 'hero_set_donation_mobile';
		...
		public function prepare_fields() {
			...
			$shortcode_ui_args = [
				'label'         => __( 'GPEA | HERO Set+Donation Module For Mobile', 'planet4-gpea-blocks-backend' ),
