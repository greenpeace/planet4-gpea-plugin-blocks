...
if ( ! class_exists( 'Update_Section_Controller' ) ) {
	/**
	 ...
	 */
	class Update_Section_Controller extends Controller {

		/** @const string BLOCK_NAME */
		const BLOCK_NAME = 'update_section';
		...
		public function prepare_fields() {
			...
			$fields = [
				...
				[
					...
					'meta'	   => [
						'select2_options' => [
							'allowClear'			 => true,
							'placeholder'			 => __( 'Select updates', 'planet4-blocks-backend' ),
							'closeOnSelect'			 => false,
			...
			$shortcode_ui_args = [
				'label'			=> __( 'LATTE | Update Section', 'planet4-blocks' ),
